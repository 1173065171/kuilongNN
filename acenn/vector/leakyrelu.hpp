...
#ifndef __VECTOR_LEAKYRELU_HPP__
#define __VECTOR_LEAKYRELU_HPP__
...
void leakyrelu(int8_t *input_block, int M, int K, int col, int8_t *output_vector)
{
  ...
  __kuiloong_ace_vmax(raddr, waddr);
}
